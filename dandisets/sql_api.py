...
class SQLSecurityValidator:
    ...
    ALLOWED_TABLE_PREFIXES = {
        'dandisets_accessrequirements',
        'dandisets_activity',
        'dandisets_activity_agents',
        'dandisets_activity_contributors',
        'dandisets_activity_equipment',
        'dandisets_activity_software',
        'dandisets_affiliation',
        'dandisets_agent',
        'dandisets_anatomy',
        'dandisets_approachtype',
        'dandisets_assaytype',
        'dandisets_asset',
        'dandisets_asset_access_requirements',
        'dandisets_asset_activities',
        'dandisets_asset_approaches',
        'dandisets_asset_measurement_techniques',
        'dandisets_asset_participants',
        'dandisets_assetdandiset',
        'dandisets_assetssummary',
        'dandisets_assetssummaryapproach',
        'dandisets_assetssummarydatastandard',
        'dandisets_assetssummarymeasurementtechnique',
        'dandisets_assetssummaryspecies',
        'dandisets_contactpoint',
        'dandisets_contributor',
        'dandisets_contributoraffiliation',
        'dandisets_dandiset',
        'dandisets_dandiset_anatomy',
        'dandisets_dandiset_disorders',
        'dandisets_dandiset_generic_types',
        'dandisets_dandisetaccessrequirements',
        'dandisets_dandisetcontributor',
        'dandisets_dandisetethicsapproval',
        'dandisets_dandisetrelatedresource',
        'dandisets_dandisetwasgeneratedby',
        'dandisets_disorder',
        'dandisets_equipment',
        'dandisets_ethicsapproval',
        'dandisets_generictype',
        'dandisets_lindimetadata',
        'dandisets_measurementtechniquetype',
        'dandisets_participant',
        'dandisets_resource',
        'dandisets_sampletype',
        'dandisets_sextype',
        'dandisets_software',
        'dandisets_speciestype',
        'dandisets_standardstype',
        'dandisets_straintype',
        'dandisets_synctracker',
    }
